   ...
   + ' <div>  <h3 class="card-title pt-2 text-primary " > <i class="fas fa-tools"></i> <strong>Soporte Tecnico</strong></h3>'
                + '          <h3 class="pb-4 text-center  ">No dejes que tu <strong   class="font-weight-bold">    Maquina</strong> deje de <strong class="font-weight-bold">Funcionar</strong></h3>'
                + '  <button type="button" class="btn btn-ver-mas-servicios btn-rounded text-white font-weight-bold">Ver Mas </button>'
                + '      </div>     </div>   </div> </div> '
            ...
            +'   <div class="col-md-12 col-sm-12 col-lg-6 col-xl-6 text-center ">'
             +'   <h3 class="h1-responsive   text-white  mt-sm-5 text-center font-weight-bold  ">'
              ...
              +'    aqui , Tu'
                ...
                +'   </button>'
                +'     <button type="button"'
                +'           class="btn btn-contactos btn-rounded text-white font-weight-bold   "> Ver Mas'
                +'        </button> </div>'
                +'  </div>');
  $('.texto-carousel-servicios').html(' <div class="row    mt-md-3 pt-md-3   mt-xl-5 pt-xl-5  mt-lg-5 pt-lg-5 ">'
                +' <div class="col-md-12 col-sm-12 col-lg-6   text-center">'
                 +'   <h3   class="h1-responsive   text-white  mt-sm-5 text-center font-weight-bold  ">'
                    +'       Soluciones Informaticas</h3>    <hr class="hr-light ">'
                        +'   <h5 class="mb-4  text-center   text-white">Nos<strong'
                 +'           class="font-weight-bold"> Dedicamos</strong> al Servicio de Soporte Tecnico'
      ...
      + '   <div>                   <h1 class="h1-responsive  font-weight-bold ">   Personas </h1>' 
        + '                                <h4 class="mb-4    "> <strong class="font-weight-bold">Somos la Solucion' 
                        + '                                 </strong>, a tus problemas tecnologicos                               </h4>' 
    + '                          </div>      </div>    </div>         </div>        ' 
